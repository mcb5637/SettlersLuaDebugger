...
namespace LuaDebugger
{
    public class RichTextBoxLink : RichTextBox
    {
        ...
        public RichTextBoxLink()
        {
            ...
            linkStruct = Marshal.AllocCoTaskMem(Marshal.SizeOf(typeof(CHARFORMAT2_STRUCT)));
        }

        ~RichTextBoxLink()
        {
            Marshal.FreeCoTaskMem(linkStruct);
        }
        ...
        private void SetSelectionStyle(UInt32 mask, UInt32 effect)
        {
            ...
            Marshal.StructureToPtr(cf, linkStruct, false);

            IntPtr res = SendMessage(Handle, EM_SETCHARFORMAT, wpar, linkStruct);
        ...
        private int GetSelectionStyle(UInt32 mask, UInt32 effect)
        {
            ...
            IntPtr res = SendMessage(Handle, EM_GETCHARFORMAT, wpar, linkStruct);

            cf = (CHARFORMAT2_STRUCT)Marshal.PtrToStructure(linkStruct, typeof(CHARFORMAT2_STRUCT));
